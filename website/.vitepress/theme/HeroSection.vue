...
<template>
  <section class="hero-section">
    ...
    <div class="hero-container" :class="{ visible }">
      ...
      <h1 class="hero-title">
        <span class="hero-brand">cf</span>
        <span class="hero-divider"></span>
        <span class="hero-headline">Confluence, but for<br><span class="hero-accent">AI agents</span></span>
      </h1>

      <p class="hero-description">
        The CLI that gives AI agents full control over Confluence.
        <span class="hero-dim">242 commands auto-generated from OpenAPI. JSON in, JSON out. Drop-in skill for Claude Code, Cursor, Codex, and more.</span>
      </p>
      ...
      <div class="hero-actions">
        <a href="/confluence-cli/guide/getting-started" class="btn-primary">
          Get Started
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
        </a>
        <a href="https://github.com/sofq/confluence-cli" class="btn-secondary" target="_blank">
    ...
    <div class="hero-terminal" :class="{ visible: terminalVisible }">
      ...
      <div class="term-body">
        ...
        <div class="term-line">
          <span class="term-prompt">$</span>
          <span class="term-cmd">cf pages get</span>
          <span class="term-flag">--id</span>
          <span class="term-val">12345</span>
          <span class="term-flag">--preset</span>
          <span class="term-val">agent</span>
        </div>
        <div class="term-line term-blank"></div>
        <div class="term-line term-output">
          <span class="term-json">{</span>
          <span class="term-key">"id"</span><span class="term-json">:</span>
          <span class="term-str">"12345"</span><span class="term-json">,</span>
          <span class="term-key">"title"</span><span class="term-json">:</span>
          <span class="term-str">"Deploy Runbook"</span><span class="term-json">,</span>
          <span class="term-key">"status"</span><span class="term-json">:</span>
          <span class="term-str">"current"</span>
          <span class="term-json">}</span>
        </div>
        <div class="term-line term-blank"></div>
        <div class="term-line">
          <span class="term-prompt">$</span>
          <span class="term-cmd">cf diff</span>
          <span class="term-flag">--id</span>
          <span class="term-val">12345</span>
        ...
        <div class="term-line term-output">
          <span class="term-json">[{</span>
          <span class="term-key">"version_from"</span><span class="term-json">:</span>
          <span class="term-val">3</span><span class="term-json">,</span>
          <span class="term-key">"version_to"</span><span class="term-json">:</span>
          <span class="term-val">5</span><span class="term-json">,</span>
          <span class="term-key">"title_changed"</span><span class="term-json">:</span>
          <span class="term-val">true</span>
          <span class="term-json">}]</span>
        </div>
        <div class="term-line">
