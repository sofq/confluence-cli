...
func AllSchemaOps() []SchemaOp {
	return []SchemaOp{
		...
		{
			Resource: "attachments",
			Verb:     "get-thumbnail-by-id",
			Method:   "GET",
			Path:     "/attachments/{id}/thumbnail/download",
			Summary:  "Download attachment thumbnail by id",
			HasBody:  false,
			Flags: []SchemaFlag{
				{
					Name:        "id",
		...
		{
			Resource: "space-permissions",
			Verb:     "list-space-permission-combinations",
			Method:   "GET",
		...
		{
			Resource: "space-permissions",
			Verb:     "generate-space-permission-combinations",
			Method:   "POST",
			Path:     "/space-permissions/transition/combinations",
		...
		{
			Resource: "space-permissions",
			Verb:     "bulk-assign-space-permission-roles",
			Method:   "POST",
		...
		{
			Resource: "space-permissions",
			Verb:     "bulk-remove-space-permission-access",
			Method:   "POST",
		...
		{
			Resource: "space-permissions",
			Verb:     "get-space-permission-transition-task-status",
			Method:   "GET",
